...
<head>
    ...
    <!-- vendor css -->
    <link href="{{asset('assets/admin/lib/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/admin/lib/ionicons/css/ionicons.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/admin/lib/typicons.font/typicons.css')}}" rel="stylesheet">
    <link href="{{asset('assets/admin/lib/flag-icon-css/css/flag-icon.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{asset('assets/admin/lib/ionicons/ionicons.js')}}"></script>
    ...
    <script src="{{asset('assets/admin/lib/chart.js/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('assets/admin/lib/peity/jquery.peity.min.js')}}"></script>

    <script src="{{asset('assets/admin/js/azia.js')}}"></script>
