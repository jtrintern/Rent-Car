        ...
        <div class="row row-sm mg-b-20">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{ old('carName') }}" type="text"
                        name="carName" id="name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="">Car Brand</label>
                    <input class="form-control" value="{{ old('carBrand') }}" type="text"
                        name="carBrand" id="">
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row row-sm mg-b-20">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input value="{{ old('coverImage') }}" name="coverImage" class="form-control"
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input value="{{ old('galleryImage[]') }}" name="galleryImage[]" multiple
