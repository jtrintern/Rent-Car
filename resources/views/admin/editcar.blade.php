        ...
        <div class="row row-sm mg-b-20">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" value="{{ $car->carName }}" type="text" name="carName" id="name">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="">Car Brand</label>
                    <input class="form-control" value="{{ $car->carBrand }}" type="text" name="carBrand" id="">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
        ...
        <div class="row row-sm mg-b-20">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" name="totalSit" id="name" value="{{ $car->totalSit }}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" style="text-transform:uppercase"
                        oninput="this.value = this.value.toUpperCase()" name="noPol" id="" value="{{ $car->noPol }}">
                </div>
            </div>
        </div>
        <div class="row row-sm mg-b-20">
