...
@section('content')
  ...
  <section id="breadcrumbs" class="breadcrumbs">
    ...
    <section id="all-car" class="all-car">
      ...
      <div class="container">
        <div class="products row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 g-lg-3" data-aos="fade-up"  data-aos-delay="200">
              ...
              <div class="card-body h-100">
                ...
                <div class="button-kendaraan">
                  <div class="homecar-button">
                    <button class="btn-homecar"  onclick="window.location.href = '{{ route('detail') }}'">Lihat Kendaraan</button>
                  </div>
                </div>
              </div>
        ...
        <div class="homecar-button"
          ...
          <button class="btn-banyak center-block">Muat Lebih Banyak</button>
        </div>
      </div>
    </section><!-- End #main -->
@endsection