    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 entry-button flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                <button class="btn-entry" onclick="window.location.href='{{route ('detailkendaraan')}}'">Kembali</button>
            </div>
        </div>
    </div>
            ...
            <div class="card-body px-5">
                ...
                <div class="data-pesanan">
                    <div class="row d-flex">
                        <div class="col-md-4">
                            <label for="exampleDropdownFormEmail1" class="form-label">Unit
                                Kendaraan</label> <span style="color: var(--primary-color);"> *</span>
                            <select class="form-select" aria-label="Default select example">
                                <option selected class="selected">Pilih Kendaraan</option>
                        ...
                        <div class="col-md-4">
                            <label for="exampleDropdownFormEmail1" class="form-label">Masa
                                Sewa</label> <span style="color: var(--primary-color);"> *</span>
                            <select class="form-select" aria-label="Default select example">
                    ...
                    <div class="div">
                        ...
                        <div class="pt-3 d-flex">
                            <div class="col-lg-8 row">
                                ...
                                <span style="color: var(--primary-color); font-weight: bold; font-size: 20px;">Rp.
                                    300.000</span>
                            </div>
                            <div class="col-lg-4">
                                <button class="btn-bayar" type="button" style="float: right;" data-bs-toggle="modal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="content">
                                        <img src="{{ asset('/rentCar/assets/img/modal.png') }}"
                                            alt="">
                                        <h3>Peringatan !</h3>
