        ...
        <div class="row">
            <div class="col-lg-8 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                ...
                <ol>
                    ...
                    <li><a style="color: #E1B12C;" href="/detailcar/{{ $car->id }}">Detail Kendaraan</a></li>
            ...
            <div class="col-lg-4 entry-button flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1">
                <button class="btn-entry"
                    onclick="window.location.href='{{ route ('listkendaraan') }}'">Kembali</button>
            </div>
        </div>
    </div>
                        ...
                        <div class="carousel-inner">
                            @foreach($car->galleryImage as $key => $img )
                                ...
                                <div
                                    ...
                                    <img src="{{ asset('images/gallery/'.$img) }}" alt="Hills">
                                </div>
                            @endforeach
                        </div>
                ...
                <div class="col-lg-7 kendaraan-info">
                    ...
                    <div class="row d-flex">
                        <div class="col-sm-3 d-flex">
                            <div>
                                <img src="{{ asset ('assets/rentCar/assets/img/detail-kendaraan/icon-kursi.png') }}"
                                    alt="">
                            </div>
                            <div>
                                <h4>Tempat Duduk</h4>
                        ...
                        <div class="col-sm-3 d-flex">
                            <div>
                                <img src="{{ asset ('assets/rentCar/assets/img/detail-kendaraan/icon-bagasi.png') }}"
                                    alt="">
                            </div>
                            <div class="div">
                                <h4>Bagasi</h4>
                        ...
                        <div class="col-sm-3 d-flex">
                            <div>
                                <img src="{{ asset ('assets/rentCar/assets/img/detail-kendaraan/icon-transmisi.png') }}"
                                    alt="">
                            </div>
                            <div class="div">
                                <h4>Transmisi</h4>
                        ...
                        <div class="col-sm-3 d-flex">
                            <div>
                                <img src="{{ asset ('assets/rentCar/assets/img/detail-kendaraan/icon-bahanbakar.png') }}"
                                    alt="">
                            </div>
                            <div class="div">
                                <h4>Bahan Bakar</h4>
                        ...
                        <div class="col-sm-12 d-flex mt-4">
                            <div>
                                <img src="{{ asset ('assets/rentCar/assets/img/detail-kendaraan/icon-kendaraan.png') }}"
                                    alt="">
                            </div>
                            <div class="div">
                                <h5>
