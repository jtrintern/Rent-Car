                ...
                <div class="products row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 g-lg-3"
                    ...
                    <div class="product col">
                        <div class="card card-product shadow-sm h-100">
                            <img class="card-img-top" src='{{ asset('rentCar/assets/img/all car/car 1.png') }}'
                                alt=''>
                  ...
                  Lorem ipsum dolor sit amet
                    ...
                    <div class="product col">
                        <div class="card card-product shadow-sm h-100">
                            <img class="card-img-top" src='{{ asset('rentCar/assets/img/all car/car 2.png') }}'
                                alt=''>
                            <div class="card-body h-100">
                  ...
                  Lorem ipsum dolor sit amet
                    ...
                    <div class="product col">
                        <div class="card card-product shadow-sm h-100">
                            <img class="card-img-top" src='{{ asset('rentCar/assets/img/all car/car 3.png') }}'
                                alt=''>
                            <div class="card-body h-100">
                  ...
                  Lorem ipsum dolor sit amet
                    ...
                    <div class="product col">
                        <div class="card card-product shadow-sm h-100">
                            <img src='{{ asset('rentCar/assets/img/all car/car 1.png') }}'' alt=''
                                class="card-img-top">
                            <div class="card-body h-100">
                                <h2 class="card-title">Toyota Avanza Veloz</h2>
                                <h3 class="card-title"><span>Rp.250.000</span> /Hari</h3>
